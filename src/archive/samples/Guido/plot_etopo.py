...
fitopo = Dataset('../pct_glacier_0.23x0.31.nc','r')
...
csai = mai.contourf(xai, yai, itopo, tlvsi, cmap=cm.pink)
...
caxai = plt.axes([li+wi+0.01+baroffset, bi, 0.02, hi]) # setup colorbar axes
