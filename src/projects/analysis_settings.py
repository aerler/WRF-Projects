...
variables_rc['precip_xtrm1d']   = VL(vars=('MaxPrecip_1d', 'MaxPreccu_1d'), files=('hydro',), label='Precipitation')
variables_rc['precip_xtrm5d']   = VL(vars=('MaxPrecip_5d', 'MaxSolprec_5d'), files=('hydro',), label='Precipitation')
...
variables_rc['sfcflx_xtrm5d']   = VL(vars=('MaxWaterflx_5d', 'MaxRunoff_5d', 'MaxSfroff_5d'), files=('hydro','lsm'), label='Water Flux')
...
variable_plotargs_rc['MaxSolprec_1d']  = AttrDict(color = 'dodgerblue')
variable_plotargs_rc['MaxSolprec_5d']  = AttrDict(color = 'dodgerblue')
