...
experiments['erai-t3'] = Exp(shortname='erai-t3', name='erai-g', title='T (ERA-I, 90km)')
# experiments['t3-ctrl'] = Exp(shortname='t3-ctrl', name='t3-ctrl', title='T-Ctrl (90km)', ensemble='t3-ensemble')
# experiments['t3-ctrl-2050'] = Exp(shortname='t3-ctrl-2050', name='t3-ctrl-2050', title='T-Ctrl (2050, 90km)', begindate='2045-01-01', ensemble='t3-ensemble-2050')
# experiments['t3-ctrl-2100'] = Exp(shortname='t3-ctrl-2100', name='t3-ctrl-2100', title='T-Ctrl (2100, 90km)', begindate='2085-01-01', ensemble='t3-ensemble-2050')
# experiments['t3-ens-A'] = Exp(shortname='t3-ens-A', name='t3-ens-A', title='T-Ens-A', parent='Ens-A (90km)', ensemble='t3-ensemble')
# experiments['t3-ens-A-2050'] = Exp(shortname='t3-ens-A-2050', name='t3-ens-A-2050', title='T-Ens-A (2050, 90km)', parent='Ens-A-2050', ensemble='t3-ensemble-2050', begindate='2045-01-01')
# experiments['t3-ens-A-2100'] = Exp(shortname='t3-ens-A-2100', name='t3-ens-A-2100', title='T-Ens-A (2100, 90km)', parent='Ens-A-2100', ensemble='t3-ensemble-2100', begindate='2085-01-01')
# experiments['t3-ens-B'] = Exp(shortname='t3-ens-B', name='t3-ens-B', title='T-Ens-B', parent='Ens-B (90km)', ensemble='t3-ensemble')
# experiments['t3-ens-B-2050'] = Exp(shortname='t3-ens-B-2050', name='t3-ens-B-2050', title='T-Ens-B (2050, 90km)', begindate='2045-01-01', parent='Ens-B-2050', ensemble='t3-ensemble-2050')
# experiments['t3-ens-B-2100'] = Exp(shortname='t3-ens-B-2100', name='t3-ens-B-2100', title='T-Ens-B (2100, 90km)', begindate='2085-01-01', parent='Ens-B-2100', ensemble='t3-ensemble-2100')
# experiments['t3-ens-C'] = Exp(shortname='t3-ens-C', name='t3-ens-C', title='T-Ens-C', parent='Ens-C (90km)', ensemble='t3-ensemble')
# experiments['t3-ens-C-2050'] = Exp(shortname='t3-ens-C-2050', name='t3-ens-C-2050', title='T-Ens-C (2050, 90km)', begindate='2045-01-01', parent='Ens-C-2050', ensemble='t3-ensemble-2050')
# experiments['t3-ens-C-2100'] = Exp(shortname='t3-ens-C-2100', name='t3-ens-C-2100', title='T-Ens-C (2100, 90km)', begindate='2085-01-01', parent='Ens-C-2100', ensemble='t3-ensemble-2100')
# experiments['t3-ensemble'] = Exp(shortname='t3-ens', name='t3-ensemble', title="T-Ens. (90km)", parent='Ens')
# experiments['t3-ensemble-2050'] = Exp(shortname='t3-ens-2050', name='t3-ensemble-2050', title='T-Ens. (2050, 90km)', begindate='2045-01-01', parent='Ens-2050')
# experiments['t3-ensemble-2100'] = Exp(shortname='t3-ens-2100', name='t3-ensemble-2100', title='T-Ens. (2100, 90km)', begindate='2085-01-01', parent='Ens-2050')
# G-Ensemble
...
experiments['erai-g3'] = Exp(shortname='erai-g3', name='erai-g', title='G (ERA-I, 90km)')
experiments['g3-ctrl'] = Exp(shortname='g3-ctrl', name='g3-ctrl', title='G-Ctrl (90km)', ensemble='g3-ensemble')
experiments['g3-ctrl-2050'] = Exp(shortname='g3-ctrl-2050', name='g3-ctrl-2050', title='G-Ctrl (2050, 90km)', begindate='2045-01-01', ensemble='g3-ensemble-2050')
experiments['g3-ctrl-2100'] = Exp(shortname='g3-ctrl-2100', name='g3-ctrl-2100', title='G-Ctrl (2100, 90km)', begindate='2085-01-01', ensemble='g3-ensemble-2050')
experiments['g3-ens-A'] = Exp(shortname='g3-ens-A', name='g3-ens-A', title='G-Ens-A', parent='Ens-A (90km)', ensemble='g3-ensemble')
experiments['g3-ens-A-2050'] = Exp(shortname='g3-ens-A-2050', name='g3-ens-A-2050', title='G-Ens-A (2050, 90km)', parent='Ens-A-2050', ensemble='g3-ensemble-2050', begindate='2045-01-01')
experiments['g3-ens-A-2100'] = Exp(shortname='g3-ens-A-2100', name='g3-ens-A-2100', title='G-Ens-A (2100, 90km)', parent='Ens-A-2100', ensemble='g3-ensemble-2100', begindate='2085-01-01')
experiments['g3-ens-B'] = Exp(shortname='g3-ens-B', name='g3-ens-B', title='G-Ens-B', parent='Ens-B (90km)', ensemble='g3-ensemble')
experiments['g3-ens-B-2050'] = Exp(shortname='g3-ens-B-2050', name='g3-ens-B-2050', title='G-Ens-B (2050, 90km)', begindate='2045-01-01', parent='Ens-B-2050', ensemble='g3-ensemble-2050')
experiments['g3-ens-B-2100'] = Exp(shortname='g3-ens-B-2100', name='g3-ens-B-2100', title='G-Ens-B (2100, 90km)', begindate='2085-01-01', parent='Ens-B-2100', ensemble='g3-ensemble-2100')
experiments['g3-ens-C'] = Exp(shortname='g3-ens-C', name='g3-ens-C', title='G-Ens-C', parent='Ens-C (90km)', ensemble='g3-ensemble')
experiments['g3-ens-C-2050'] = Exp(shortname='g3-ens-C-2050', name='g3-ens-C-2050', title='G-Ens-C (2050, 90km)', begindate='2045-01-01', parent='Ens-C-2050', ensemble='g3-ensemble-2050')
experiments['g3-ens-C-2100'] = Exp(shortname='g3-ens-C-2100', name='g3-ens-C-2100', title='G-Ens-C (2100, 90km)', begindate='2085-01-01', parent='Ens-C-2100', ensemble='g3-ensemble-2100')
experiments['g3-ensemble'] = Exp(shortname='g3-ens', name='g3-ensemble', title="G-Ens. (90km)", parent='Ens')
experiments['g3-ensemble-2050'] = Exp(shortname='g3-ens-2050', name='g3-ensemble-2050', title='G-Ens. (2050, 90km)', begindate='2045-01-01', parent='Ens-2050')
experiments['g3-ensemble-2100'] = Exp(shortname='g3-ens-2100', name='g3-ensemble-2100', title='G-Ens. (2100, 90km)', begindate='2085-01-01', parent='Ens-2050')
