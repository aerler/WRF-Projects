...
experiments['max-ensemble'] = Exp(shortname='max-ens', name='max-ensemble', title='WRF G', begindate='1979-01-01', grid='arb2', parent='Ens')
...
experiments['max-ensemble-2050'] = Exp(shortname='max-ens-2050', name='max-ensemble-2050', title='WRF G (2050)', begindate='2045-01-01', grid='arb2', parent='Ens-2050')
...
experiments['max-ensemble-2100'] = Exp(shortname='max-ens-2100', name='max-ensemble-2100', title='WRF G (2100)', begindate='2085-01-01', grid='arb2', parent='Ens-2100')
...
experiments['erai-ctrl'] = Exp(shortname='erai-ctrl', name='erai-ctrl', title='Ctrl (ERA-I)', begindate='1979-01-01', grid='arb2', parent='ERA-I')
...
experiments['ctrl-ensemble'] = Exp(shortname='ctrl-ens', name='ctrl-ensemble', title='WRF T', begindate='1979-01-01', grid='arb2', parent='Ens')
...
experiments['ctrl-ensemble-2050'] = Exp(shortname='ctrl-ens-2050', name='ctrl-ensemble-2050', title='WRF T (2050)', begindate='2045-01-01', grid='arb2', parent='Ens-2050')
...
experiments['ctrl-ensemble-2100'] = Exp(shortname='ctrl-ens-2100', name='ctrl-ensemble-2100', title='WRF T (2100)', begindate='2085-01-01', grid='arb2', parent='Ens-2100')
